...
- kind: command
  target: mix test test/providers/xai/execution_stack_test.exs test/providers/xai/wire_responses_test.exs test/providers/zenmux/execution_stack_test.exs test/providers/zenmux/wire_chat_test.exs test/providers/zenmux/wire_responses_test.exs test/providers/google/execution_stack_test.exs test/providers/google/wire_generate_content_test.exs
  execute: true
  covers:
    - reqllm.layer_boundaries.separated_io
    - reqllm.layer_boundaries.no_cross_layer_skips
