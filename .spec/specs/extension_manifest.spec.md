...
- kind: command
  target: mix test test/providers/deepseek/execution_stack_test.exs test/providers/groq/execution_stack_test.exs test/providers/openrouter/execution_stack_test.exs test/providers/vllm/execution_stack_test.exs test/providers/xai/execution_stack_test.exs test/providers/zenmux/execution_stack_test.exs test/providers/google/execution_stack_test.exs test/model_profile_test.exs
  execute: true
  covers:
    - reqllm.extension_manifest.plain_runtime_contract
    - reqllm.extension_manifest.family_precedence
